...
void getandshowData() {
  ...
  for (int i = 0; i < 5; i++) {
    std::cout << "Name of student " << i+1 << " is " << s[i].fname << std::endl;
    std::cout << "Roll no of student " << i+1 << " is " << s[i].roll << std::endl;
    std::cout << "Marks of student " << i+1 << " is " << s[i].marks << std::endl;
    std::cout << std::endl;
  }
}
